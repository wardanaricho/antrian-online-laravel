        ...
        <div class="row h-100">
            ...
            <div class="col-12 col-lg-6">
                <div class="m-2">
                    ...
                    <form action="/simpan-pasien-online" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group position-relative mb-2">
                                    <input type="text" class="form-control" name="nik" id="nik"
                                        maxlength="16" placeholder="Nomor Induk Kependudukan" required autofocus>
                                </div>
                            </div>
                            <div class="col-lg-12">
                    ...
                    <div class="text-center mt-3 text-lg fs-4">
                        <p class='text-gray-600'>Sudah terdaftar?
                            <a href="/" class="font-bold">Ambil Antrian Online</a>.
                        </p>
                    </div>
                </div>
            </div>
