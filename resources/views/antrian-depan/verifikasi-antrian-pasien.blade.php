        ...
        <div class="row h-100">
            ...
            <div class="col-lg-6 col-12">
                <div id="auth-left">
                    ...
                    <p class="mb-4">Verifikasi Data Pasien</p>

                    <h5>Silahkan koreksi data diri, jika sudah benar maka klik tombol ambil antrian</h5>
                    <form action="/ambil-antrian" method="POST">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-striped table-bordered border-dark">
                                ...
                                <tr>
                                    <td>Nama</td>
                                    <td>{{ $pasien->nama_pasien }} ({{ $pasien->jenis_kelamin }})</td>
                                </tr>
                                <tr>
                                    <td>TTL</td>
                        ...
                        <div class="text-center mt-3 text-lg fs-4">
                            <input type="submit" class="font-bold btn btn-success btn-xl fs-4" value="Ambil Antrian">
                        </div>
                    </form>
                </div>
            </div>
