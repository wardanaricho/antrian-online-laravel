...
<head>
    ...
    <title>Hasil Antrian Online</title>
            ...
            <div class="col-lg-6 col-12">
                <div id="auth-left">
                    <div class="text-center">
                        ...
                        <p class="mb-4">Hasil Antrian Online</p>
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered border-dark text-center align-middle">
                            <tr>
                                <td style="width: 50%">
                                    {!! QrCode::size(100)->generate(
                                        'Nomor antrian anda adalah : ' .
                                            ...
                                            "\n" .
                                            'Dengan Dokter yang dituju adalah : ' .
                                ...
                                <td>
                                    <span style="font-size: 80px; margin: 0px; padding: 0px" class="text-dark">
                                        {{ $antrian->no_antrian }}
                                    </span>
                                </td>
                            </tr>
                        ...
                        <table class="table table-sm table-striped">
                            ...
                            <tr>
                                <td colspan="3" class="text-center">
                                    <a href="/cetak-antrian/{{ $antrian->tanggal }}/{{ $antrian->no_rkm_medis }}/{{ $antrian->no_antrian }}"
                    ...
                    <div class="text-center mt-3 text-lg fs-4">
                        <p class='text-gray-600'>
                            <a href="/" class="font-bold btn btn-primary">Ambil Antrian Online Lagi</a>
                        </p>
                    </div>
                </div>
            </div>
