        ...
        <div class="row h-100">
            ...
            <div class="col-12 col-lg-6">
                <div class="m-2">
                    ...
                    <h5>Selamat anda sudah terdaftar, Berikut data diri anda</h5>
                    ...
                    <div class="text-center mt-3 text-lg fs-4">
                        <p class='text-gray-600'>
                            <a href="/" class="font-bold btn btn-primary">Ambil Antrian Online</a>
                        </p>
                        <a href="/download-pasien-online/{{ $pasien->no_rkm_medis }}" class="btn btn-success">Download
                            PDF</a>
                    </div>
                </div>
            </div>
