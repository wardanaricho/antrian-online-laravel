...
<head>
    ...
    <title>Daftar Pasien Online</title>
            ...
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <div class="alert alert-warning text-center">
                        <h4>Antrian hari ini sudah penuh!</h4>
                        <p>Apakah Anda ingin mengambil antrian untuk besok ({{ $tglBesok }})?</p>
                    </div>

                    <form action="/ambil-antrian-besok" method="POST">
                        @csrf
                        <input type="hidden" name="no_rkm_medis" value="{{ $no_rkm_medis }}">
                        <input type="hidden" name="id_dokter" value="{{ $id_dokter }}">
                        <input type="hidden" name="tanggal" value="{{ $tglBesok }}">
                        <div class="text-center mt-3">
                            <button type="submit" class="btn btn-primary">Ya, Ambil Antrian Besok</button>
                            <a href="/" class="btn btn-secondary">Tidak, Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
